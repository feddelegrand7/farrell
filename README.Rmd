...
If you use the farrell package in your publications or teaching activities, please cite it as follows:
 ...
 Mohamed El Fodil Ihaddaden (2020). farrell: Interactive
  Interface to Data Envelopment Analysis Modeling Based
  on the 'Benchmarking' Package. R package version 0.2.0.
  https://github.com/feddelegrand7/farrell

A BibTeX entry for LaTeX users is

  @Manual{,
    title = {farrell: Interactive Interface to Data Envelopment Analysis Modeling Based on the 'Benchmarking' Package},
